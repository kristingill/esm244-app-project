               ...
               tabPanel("Strandings by Life Stage & Sex",
                        sidebarLayout(
                            sidebarPanel("Sea Otter Strandings",
                                         ...
                                         p("Pick a life stage to see that group represented by different colors on the graph (you can click on the life stage boxes and backspace to remove a group from the graph). You also have the option to choose otter gender (note: this will only change the count reflected on the graph)."),
