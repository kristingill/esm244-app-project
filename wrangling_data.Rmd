...
sea_otter_pop %>% 
 ...
 sea_otter_count <- ggplot(data = sea_otter_pop, aes(x = year, y = n)) +
  geom_line() +
  labs(x = "Year", y = "Sea Otter Count") +
  facet_wrap(~zone_code) +
  theme_minimal()
 
 ggplotly(sea_otter_count)
```
...
![Southern Sea Otter Range. Image from U.S. Fish and Wildlife](Sea_Otter_Population_Range.png)
